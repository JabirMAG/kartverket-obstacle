...
{
    // Controller for varslingsfunksjonalitet. Håndterer visning av kommentarer/rapporter på brukerens hindringer. Kun tilgjengelig for Pilot-brukere.
    ...
    public class VarslingController : Controller
    {
        ...
        // Viser alle varslinger (kommentarer/rapporter) for hindringer eid av den innloggede piloten. Filtrerer bort auto-genererte kommentarer og grupperer etter hindring.
        [HttpGet]
        ...
        // Viser detaljert visning av en hindring og dens rapporter for den innloggede piloten. Kun hindringer eid av den innloggede piloten kan vises.
        [HttpGet]
        ...
        // Henter antall nye/uleste varslinger (kommentarer fra admin/registerfører) for den nåværende pilotbrukeren. Returnerer 0 hvis brukeren ikke er pilot eller ikke autentisert.
        [HttpGet]
        [AllowAnonymous]
        ...
        // Bygger ViewModel-liste for varslinger gruppert etter hindring. Bruker hindringer allerede inkludert i kommentarene for å unngå N+1 spørringsproblem.
        private Task<List<VarslingViewModel>> BuildVarslingViewModelsAsync(List<RapportData> userComments)
        {
            ...
            {
                // Bruker hindring allerede inkludert i kommentaren for å unngå ekstra databasekall
